...
private:
	Vector3 target;
	const Vector3 spinAxis = { //randomized spin axis
	...
	unsigned char cblue = (unsigned char)GetRandomValue(100, 150); //randomized blue color component for asteroid
	
	virtualCamera::sVector3 points[4] = { //randomized design of the asteroid
